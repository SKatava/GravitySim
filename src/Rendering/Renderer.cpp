...
bool Renderer::InitRenderer(){
    glViewport(460, 200, 800, 800);
    glDisable(GL_DEPTH_TEST);
    glEnable(GL_POINT_SMOOTH);
    glEnable(GL_MULTISAMPLE);
    m_defaultShader = new Shader("shaders/default.vert", "shaders/default.frag");
    m_particleShader = new Shader("shaders/particle.vert", "shaders/particle.frag");
    m_SSBOparticleShader = new Shader("shaders/particleSSBO.vert", "shaders/particleSSBO.frag");
